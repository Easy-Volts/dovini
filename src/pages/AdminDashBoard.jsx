...
import { LayoutDashboard, Package, ShoppingCart, Users, X, PlusCircle, Trash2, Edit2, CheckCircle, Save, AlertTriangle, Image, UploadCloud, LogOut, TrendingUp, TrendingDown, DollarSign, Eye, Calendar, MapPin, Star, Activity, ShoppingBag, Target, Award } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-xl overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            {['Customer ID', 'Full Name', 'Email', 'Phone', 'Status', 'Registered Date', 'Address', 'Role'].map(header => (
                                <th key={header} className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                    {header}
                                </th>
                            ))}
